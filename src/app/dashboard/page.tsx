...
type Tab = "shop" | "drops" | "community" | "club" | "benefits" | "sponsorships";

const VALID_TABS: Tab[] = ["shop", "drops", "community", "club", "benefits", "sponsorships"];
    ...
    <div className="min-h-screen bg-bone">
      ...
      <main className={isLegacy ? "pt-56 pb-24" : "pt-48 pb-24"}>
        <div key={activeTab} className="animate-tab-in">
          ...
          {activeTab === "sponsorships" && (isPaid ? <SponsorshipsTab /> : <GatedTab type="sponsorships" onUpgrade={() => setUpgradeOpen(true)} />)}
        </div>
      </main>
...
const GATED_CONTENT = {
  ...
  sponsorships: {
    ...
    title: "Sponsorships",
    description: "Bring members in and earn the ladder. The First Dozen, The Foursome, The Path to Black, The 18. Upgrade to unlock your link and start tracking.",
    cta: "Upgrade Membership",
    href: "/onboarding",
    features: ["Your own sponsor link", "Pro V1s, tee times, comped trips", "A path to Reserve Black"],
  },
};

function GatedTab({ type, onUpgrade }: { type: "shop" | "drops" | "club" | "benefits" | "sponsorships"; onUpgrade: () => void }) {
...
const BENEFIT_ICONS: Record<BenefitKey, React.ReactNode> = {
  ...
  pro_shop_15_off: <DiscountBenefitIcon />,
...
function DiscountBenefitIcon() {
  return (
    <svg className="w-5 h-5 text-forest" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.182 9.182a2.25 2.25 0 003.182 0l4.318-4.318a2.25 2.25 0 000-3.182L11.159 3.659A2.25 2.25 0 009.568 3z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 6.75h.008v.008H6.75V6.75zm8.25 1.5l-6.75 6.75m.75-5.25h.008v.008H9v-.008zm5.25 5.25h.008v.008h-.008V15z" />
    </svg>
  );
}
