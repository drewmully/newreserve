...
export const SHOP_CATEGORIES: ShopCategoryMeta[] = [
  {
    ...
    detail: "The layer everyone sees at the turn.",
  },
  {
    key: "bottoms",
    label: "Bottoms",
    ...
    detail: "Cut for a full swing and a stool at the bar.",
  },
  {
    key: "outerwear",
    label: "Outerwear",
    ...
    detail: "For the 6 a.m. tee time in late October.",
  },
  {
    key: "tech",
    label: "Tech",
    ...
    detail: "The number to the pin, the data after.",
  },
  {
    key: "bags",
    label: "Bags",
  ...
  },
  {
    ...
    detail: "Small pieces that tell people you play.",
  },
];
...
export const GIFT_TIERS = [
  {
    ...
    title: "Under $100",
    subtitle: "The gift that always gets opened",
    accent: "Everyday",
  },
  {
    key: "hundredToThree",
    ...
    title: "$100 – $300",
    subtitle: "The tier that carries the season",
    accent: "Signature",
  },
  {
